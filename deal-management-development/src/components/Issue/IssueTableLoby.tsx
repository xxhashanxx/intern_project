...
const IssueTableLoby = ({ searchVal }: IssueTableProps) => {
  const { status, data, error } = useQuery("issueList", useIssueService().useGetIssueListLobyService);
          ...
          <Table size="small" style={{backgroundColor:'DeepSkyBlue',}}>
            <TableHead >
              <TableRow style={{backgroundColor: theme.palette.primary.main,}}>
                ...
                {/* <TableCell style={{color: 'white'}}>Issuer ID</TableCell> */}

                {/* <TableCell>Account Name</TableCell> */}
                {/* <TableCell  style={{color: 'white'}}>Lawyer</TableCell> */}
  ...
  return (
    <>
      ...
      <StyledTableRow onClick={() => history.push(`/issue/edit/${row.issue_id}`)}
        ...
        {/* <TableCell style={{color: 'white'}}>{row.lawyer_id}</TableCell> */}
